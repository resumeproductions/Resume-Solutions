$(function() {
    ...
    $("#menuToggle, .btn-close").on("click", function(a) {
        ...
        a.stopPropagation(), $(".navmenu").offcanvas("toggle")
    }), $.backstretch(["../img/Loading.gif"], {
        duration: 3800,
        fade: 1500
    }), new WOW({
        mobile: !1
    ...
    b.imagesLoaded(function() {
        ...
        submitHandler: function(a, b, c) {
            var d = Ladda.create(c[0]),
                e = c.children(".ladda-label");
            d.start(), e.html("Sending..."), $.post(b.attr("action"), b.serialize(), function(c) {
                c.sent ? e.html("Sent!") : e.html("Error!"), setTimeout(function() {
