...
class WorkExperiencesTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$experience->description = "I worked as a lifeguard";
		$experience->title = "Lifeguard";
		$experience->start_date = "May 2012";
		$experience->end_date = "September 2012";
		...
		$experience2->start_date = "June 2013";
		$experience2->end_date = "May 2014";
		$experience2->template_id = 1;
		$experience2->save();

		$experience3 = new workExperience();
		$experience3->description = "I worked as a developer";
		$experience3->title = "Software Developer";
		$experience3->start_date = "June 2014";
		$experience3->end_date = "March 2015";
