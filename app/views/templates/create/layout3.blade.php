...
<div class='page1 pagesle'>
	<button id='input11' class='Inpage1' name='headerImage'></button>
...
<div class='page6 pagesle'>
	<button id='input61' class='Inpage6' name='portfolioPicture1'></button>
	...
	<button id='input64' class='Inpage6' name='portfolioPicture2'></button>
	...
	<button id='input67' class='Inpage6' name='portfolioPicture3'></button>
	...
	<button id='input610' class='Inpage6' name='portfolioPicture4'></button>
	...
	<button id='input613' class='Inpage6' name='portfolioPicture5'></button>
	...
	<button id='input616' class='Inpage6' name='portfolioPicture6'></button>
	...
	<button type="submit" class='Inpage6 buttons' id='submitTemplate3'></button>
</div>
